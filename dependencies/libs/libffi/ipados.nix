...
pkgs.stdenv.mkDerivation {
  ...
  preConfigure = ''
    ...
    exec "$XCODE_CLANGXX" "$@"
    EOF
    chmod +x libffi-ipados-cc libffi-ipados-cxx

    export CC="$PWD/libffi-ipados-cc"
    export CXX="$PWD/libffi-ipados-cxx"
