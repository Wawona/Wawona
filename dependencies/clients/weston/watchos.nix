...
EOF
    ...
    "$AR" rcs libweston-terminal.a    weston_terminal_mobile.o
    "$AR" rcs libweston-desktop-13.a  weston_desktop_stub.o
  '';

  installPhase = ''
    mkdir -p $out/lib
    cp libweston-13.a libweston-terminal.a libweston-desktop-13.a $out/lib/
  '';

  meta = with lib; {
    description = "Weston mobile client libraries for watchOS Wawona";
