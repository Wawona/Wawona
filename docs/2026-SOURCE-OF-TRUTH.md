...
| tvOS | UIKit | CAMetalLayer / ANGLE + MoltenVK (rendered-frame evidence pending) | native, nested Weston/Niri, waypipe | constrained zsh | Focus-engine driven; no pointer by default. GPU drivers linked (`WWN_TVOS_GPU`). VM/container forbidden. |
